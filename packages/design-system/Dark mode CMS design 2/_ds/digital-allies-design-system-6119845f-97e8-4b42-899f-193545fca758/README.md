...
Used for social media, email campaigns, ads, and promotional/blog copy —
never for site pages, docs, or customer-facing product copy. Warmer and
slightly more conversational than primary voice, but still authentic.

> *"Real talk about real problems from someone who actually answers the
> phone."*

**Tone shift vs. primary**: Casual 75% (+10) · Warm 60% (+5 vs. primary's
55% dry) · Plain 80% (+10) · Confident 70% (−5) · Authentic 100% (same).
...
> "Your customers speak two languages. Your site should too."

**Use for**: social posts, email campaigns, ad copy, blog intros/conclusions,
promotional graphics. **Don't use for**: site pages, technical docs, pricing,
contracts — those stay in primary voice. Full detail and audience personas:
`preview/brand-voice-marketing.html`.
