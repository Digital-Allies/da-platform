    ...
    <CoverFrame>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", width: 720, height: 600 }}>
          ...
          {/* Compass overprint */}
          <img src={window.__resources.iconCompass} alt="" style={{
  ...
  return (
    <CoverFrame bg="#F9F6F0">
      ...
      <div style={{
        ...
        {/* Engine A */}
        <img src={window.__resources.iconEngine} alt="" style={{
          position: "absolute", width: 280, height: 280,
          top: 140, left: 90,
          mixBlendMode: "multiply",
        }} />
  ...
  return (
    <CoverFrame bg="#F9F6F0">
      ...
      <div style={{
        ...
        <img src={window.__resources.iconMetronome} alt="" style={{
  ...
  return (
    <CoverFrame bg="#F9F6F0">
      ...
      <div style={{
        ...
        {/* Topo / contour map */}
        <img src={window.__resources.iconTopo} alt="" style={{
