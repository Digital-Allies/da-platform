...
-- FIX: Supabase projects created after April 2024 revoke CREATE
-- on the public schema by default. These two lines restore it.
-- If you see "permission denied for schema public", this is why.
